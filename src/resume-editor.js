...
exports.ResumeEditor = void 0;
const STORAGE_KEY = 'resume-data';
class ResumeEditor {
    constructor(container, initialData, onUpdate) {
    ...
    buildPersonalSection() {
        ...
        for (const f of fields) {
            section.appendChild(this.createInput(f.label, ((_a = p[f.key]) !== null && _a !== void 0 ? _a : ''), f.placeholder, (val) => {
                this.data.personal[f.key] = val;
                this.notify();
            }));
        }
        return section;
    }
    buildEntitySection(title, items, setter) {
...
exports.ResumeEditor = ResumeEditor;
